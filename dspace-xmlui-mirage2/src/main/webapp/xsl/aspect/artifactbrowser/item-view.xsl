...
<xsl:stylesheet
        ...
        <div class="item-summary-view-metadata">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-OTHERS"/>
                    <xsl:call-template name="itemSummaryView-DIM-LICENSE-URI"/>
                    <xsl:call-template name="itemSummaryView-DIM-DESCRIPCION-TRACK"/>
    ...
    <xsl:template name="itemSummaryView-DIM-OTHERS">
        <xsl:if test="dim:field[@element='identifier' and @qualifier='other' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-others</i18n:text></h5>
                <span>
    ...
    <xsl:template name="itemSummaryView-DIM-LICENSE-URI">
        <xsl:if test="dim:field[@element='rights' and @qualifier='uri' and descendant::text()]">
            <div class="simple-item-view-uri-other item-page-field-wrapper table">
    ...
    <xsl:template name="itemSummaryView-DIM-DESCRIPCION-TRACK">
        <xsl:if test="dim:field[@element='description' and @qualifier='track' and descendant::text()]">
            <div class="simple-item-view-uri-other item-page-field-wrapper table">
                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-track</i18n:text></h5>
                <span>
                    <xsl:for-each select="dim:field[@element='description' and @qualifier='track']">
                        <xsl:copy-of select="./node()"/>
                        <xsl:if test="count(following-sibling::dim:field[@element='description' and @qualifier='track']) != 0">
                            <br/>
                        </xsl:if>
                    </xsl:for-each>
                </span>
